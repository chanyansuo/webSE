  		...
  		<header id="main-menu" class="main-menu">
              ...
              <nav id="menu" class="menu collapse navbar-collapse">
               <ul id="headernavigation" class="menu-list nav navbar-nav">
                	...
                	<li class="active"><a href="index_Logined.jsp" style="width: 150px;text-align: center;">首&nbsp;&nbsp;页</a></li>
...
<!--       </div> -->
      ...
      <div class="item">
        <div class="item-image">
          <img src="../assets/images/portfolio/7.jpg" alt="Portfolio Image">
        </div>

      </div>
      <div class="item">
        <div class="item-image">
          <img src="../assets/images/portfolio/8.jpg" alt="Portfolio Image">
        </div>

      </div>
      <div class="item">
        <div class="item-image">
          <img src="../assets/images/portfolio/9.jpg" alt="Portfolio Image">
        </div>
