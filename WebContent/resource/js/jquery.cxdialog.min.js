 ...
 * Date: 2017-01-06
 *
 * ���׵��ã�$.cxDialog(string[, ok, no])
 * ����������$.cxDialog(opt)
 * @param {object|string} opt �������� or ����
 *   title {string} ����
 *   info {string|dom} ����
 *   ok {fn} ���ȷ��ʱ�Ļص�����
 *   okText {string} ȷ�ϰ�ť����
