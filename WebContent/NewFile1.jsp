...
<body>
	...
	<table id="dg" title="Client Side Pagination" style="width:700px" data-options="
				rownumbers:true,
				singleSelect:true,
				autoRowHeight:false,
				url:'data/TFdata.json',
				pagination:true,
				pageSize:10">
		<thead>
			<tr>
				<th data-options="field:'Questid',width:80">题号</th>

				<th data-options="field:'Questname',width:500,editor:'textbox'">题目</th>

				<th data-options="field:'Ansname',width:80,
				...
				<th data-options="field:'Difid',width:80,
					formatter:function(value,row){
							return row.Difname;
						},
					editor:{
