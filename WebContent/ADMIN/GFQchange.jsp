...
<script>
    ...
    $(function(){
		$.ajax({
			...
			type: "GET",
			dataType: "json",
			url: "../rest/Manage/getQuestions/1",
			async: false,
...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="填空题题库" style="width:100%;height:auto;"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'Blank_num',width:100,editor:'textbox'">空格数量</th>
				
				<th data-options="field:'Answer_one',width:100,editor:'textbox'">答案1</th>
				<th data-options="field:'Answer_two',width:100,editor:'textbox'">答案2</th>
				<th data-options="field:'Answer_three',width:100,editor:'textbox'">答案3</th>
				<th data-options="field:'Answer_four',width:100,editor:'textbox'">答案4</th>
				<th data-options="field:'Answer_five',width:100,editor:'textbox'">答案5</th>
	...
	//END
		...
		function accept(){
			...
			$.post("../rest/Manage/getChange/1", effectRow, function (rsp) {
				if (rsp) {
