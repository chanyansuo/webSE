...
<script>
    ...
    $(function(){
		$.ajax({
			...
			type: "GET",
			dataType: "json",
			url: "../rest/Manage/getQuestions/4",
			async: false,
...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="填空题题库" style="width:100%;height:auto;"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'content',width:300,editor:'textbox'">题目</th>
	...
	//END
		...
		function accept(){
			...
			$.post("../rest/Manage/getChange/4", effectRow, function (rsp) {
				if (rsp) {
